...
const unsigned int SelectionConstants::ITEMS_TO_DISPLAY = 5;
const SelectionHolder<int> SelectionConstants::SIZE(55, 33);
const SelectionHolder<sf::Color> SelectionConstants::COLOR(sf::Color(255, 122, 45), sf::Color(200,200,200));
